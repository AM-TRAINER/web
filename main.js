...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const carBoxes = document.querySelectorAll('.box'); // Adjust this selector to match your actual boxes
    ...
    // Reset  boxes when navigating to a different section
    ...
    // Optionally, you might want to reset  boxes on page load if a page reload happens
...
function googleTranslateElementInit() {
    new google.translate.TranslateElement(
        { pageLanguage: 'ka', includedLanguages: 'en,ru,de', layout: google.translate.TranslateElement.InlineLayout.SIMPLE },
